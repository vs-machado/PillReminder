...
class AlarmTriggeredViewModel : ViewModel() {
    ...
    fun checkMedicineForm(medicineForm: String, medicineQuantity: String, context: Context): String{
        return when(medicineForm){
            "pill" -> context.getString(R.string.pill_quantity, medicineQuantity.toFloat().toInt().toString())
            ...
            "drop" -> context.getString(R.string.drops_quantity, medicineQuantity.toFloat().toInt().toString())
